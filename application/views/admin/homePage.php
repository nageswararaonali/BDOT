...
<html>
  <head>
    ...
    <title>Bigdata | Admin Login</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <!--<div class="login-logo">
        <a href="#"><img src="<?php echo base_url();?>assets/dist/img/needs_logo.png" /></a>
      </div>--><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="<?php echo base_url('admin/loginAct');?>" method="post">
